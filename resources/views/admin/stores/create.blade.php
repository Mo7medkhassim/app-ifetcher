        ...
        <div class="tile shadow">
            ...
            <form method="post" action="{{ route('admin.stores.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="{{$locale}}[place]" autofocus class="form-control" value="{{ old($locale.'.place') }}">
                </div> <!-- end of place -->
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" autofocus class="form-control" value="{{ old('email') }}">
                </div> <!-- end of email -->

                <!-- phone -->
                <div class="form-group">
                    <label>{{__('admins.'.$locale.'.phone')}} <span class="text-danger">*</span></label>
                    <input type="text" name="phone" autofocus class="form-control" value="{{ old('phone') }}">
                </div> <!-- end of phone -->
                ...
                <div class="foram-group">
                    ...
                    <input class="form-control-file" id="main-img" name="logo" id="exampleInputFile" type="file" aria-describedby="fileHelp">
                    <!-- <small class="form-text text-muted" id="fileHelp">Store Logo Image.</small> -->
                </div> <!-- end of logo -->
