          ...
          <div class="row justify-content-center">
              <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
                 <a href="{{ route('front.home') }}" class="logo me-auto me-lg-0"><img src="{{ asset('site_assets/img/logoo.png') }}" alt="" class="img-fluid"></a>
                  ...
                  <a  class="language px-3 <?php if( $localeCode == app()->getLocale() ) { echo ' d-none'; } ?>" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                    {{ $properties['native'] }}
                  </a>
